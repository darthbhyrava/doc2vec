...
path = os.getcwd()
filesf = os.listdir('/home/darthbhyrava/2018/doc2vec/data/')
files_xls = [f for f in files if f[-4:] == 'xlsx']

df = pd.DataFrame()
for ind, f in enumerate(files_xls):
	print "{0}/{1}".format(ind+1,len(files_xls))
...
# making a list of most contractions
contractions = { 
"ain't": "am not",
"aren't": "are not",
"can't": "cannot",
